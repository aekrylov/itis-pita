    ...
    <div class="col-xs-offset-2 col-xs-8">
        <form role="form" class="form-horizontal" action="/profile/edit" method="POST"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                        <textarea class="form-control" rows="3" name="about_me" id="about_me">${info}
                    </textarea>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                    <textarea class="form-control" rows="3" name="interests" id="interests">${interests}</textarea>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                    <input type="text" class="form-control bfh-phone" data-format="+7 (ddd) ddd-dddd" value="${phone_number}">
                </div>
            </div>
            <div class="form-group">
...
<script src="/formhelper/js/bootstrap-formhelper-phone.js"></script>
