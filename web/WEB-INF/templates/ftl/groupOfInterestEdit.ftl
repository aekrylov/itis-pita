...
<div class="undercover">
    <div class="row">
        <div class="col-md-offset-1 col-md-9">
            <h1 class="page-header"> Изменение группы по интересам</h1>
        </div>
    </div>
    <!-- /.row -->
    <form role="form" class="" action="/group/${group.getId()}/edit" method="POST" enctype="multipart/form-data" onsubmit="return checkform([
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="resize: none"
                              ...
                              id="group_info">${group.getDescription()}</textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="form-group">
                    <button class="btn-warning btn btn-block" type="submit">Сохранить изменения</button>
                </div>
            </div>
        </div>
...
<@display "Изменение группы"></@display>
